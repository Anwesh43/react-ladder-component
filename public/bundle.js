...
var LadderComponent = function (_Component) {
	_inherits(LadderComponent, _Component);

	function LadderComponent() {
		_classCallCheck(this, LadderComponent);

		var _this = _possibleConstructorReturn(this, (LadderComponent.__proto__ || Object.getPrototypeOf(LadderComponent)).call(this));
	...
	_createClass(LadderComponent, [{
		...
		value: function getLines() {
			...
			return [0, 1, 2, 3, 4, 5].map(function (num) {
				return _react2.default.createElement(_LineComponent2.default, { i: num, stepSize: _this3.state.w / 7, offsetY: _this3.state.h / 5, gap: _this3.state.h / 12, x: _this3.state.w / 2 - _this3.state.w / 14 });
			});
		}
	}, {
		key: 'render',
...
exports.default = LadderComponent;

},{"./LineComponent":3,"react":29}],3:[function(require,module,exports){
'use strict';
...
var Line = function Line(_ref) {
	...
	return _react2.default.createElement('div', { style: { border: Math.min(w, h) / 90 + 'px solid #3F51B5', width: size, height: '0px', position: 'absolute', left: num * (x - size), top: 0 } });
};
...
var LineComponent = function (_Component) {
	...
	function LineComponent(props) {
		...
		_this.sobj = new _StateObject2.default();
		_this.state = { w: _this.props.stepSize };
		return _this;
	}
	...
	_createClass(LineComponent, [{
		...
		value: function handleTap() {
			...
			this.sobj.startUpdating(function () {
				_Animator.animator.start(function () {
					return _this2.sobj.update(function (sc) {
						_this2.setState({ w: _this2.props.stepSize * (1 - sc) });
						console.log(_this2.state.w);
					});
				});
			});
		}
		...
		value: function render() {
			...
			var y = this.props.i * this.props.gap + this.props.offsetY;
			var scaledLines = [0, 1].map(function (a) {
				return _react2.default.createElement(Line, { num: a, size: _this3.state.w / 2, x: _this3.props.stepSize, offsetX: _this3.props.x, top: y });
			});
			...
			return _react2.default.createElement(
				'div',
				{ onClick: this.handleTap.bind(this), style: { position: 'absolute', left: this.props.x, top: y } },
				scaledLines
			);
		}
	}]);
...
},{"./Animator":1,"./StateObject":4,"react":29}],4:[function(require,module,exports){
"use strict";
...
var _LadderComponent = require('./LadderComponent');

var _LadderComponent2 = _interopRequireDefault(_LadderComponent);
...
var LadderComponentDemo = function (_Component) {
	_inherits(LadderComponentDemo, _Component);

	function LadderComponentDemo() {
		_classCallCheck(this, LadderComponentDemo);

		return _possibleConstructorReturn(this, (LadderComponentDemo.__proto__ || Object.getPrototypeOf(LadderComponentDemo)).apply(this, arguments));
	}

	_createClass(LadderComponentDemo, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(_LadderComponent2.default, null)
			);
		}
	}]);

	return LadderComponentDemo;
}(_react.Component);

_reactDom2.default.render(_react2.default.createElement(LadderComponentDemo, null), document.getElementById('container'));

},{"./LadderComponent":2,"react":29,"react-dom":26}],6:[function(require,module,exports){
/**
